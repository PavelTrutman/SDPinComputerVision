...
plot[Min:Max][0:] "data/app_P3P_relax.dat" using (offset($1,1)):(1.0) title "Polyopt" smooth freq with boxes fill solid noborder lc rgb "#018816",\
                  "data/app_P3P_relax.dat" using (offset($2,2)):(1.0) title "Implementace v MATLABu s nástrojem MOSEK \\cite{mosek}" smooth freq with boxes fill solid noborder lc rgb "#da002b",\
