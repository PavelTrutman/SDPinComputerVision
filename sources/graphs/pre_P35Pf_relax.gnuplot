...
set output "graphs/pre_P35Pf_relax.tex"
...
plot[Min:Max][0:] "data/app_P35Pf_relax.dat" using (offset($1,1)):(1.0) title "Polyopt" smooth freq with boxes fill solid noborder lc rgb "#018816",\
                  "data/app_P35Pf_relax.dat" using (offset($2,2)):(1.0) title "MATLAB implementation with MOSEK \\cite{mosek}" smooth freq with boxes fill solid noborder lc rgb "#da002b",\
