...
plot[Min:Max][0:] "data/app_P35Pf_err.dat" using (offset($1,1)):(1.0) title "Reference" smooth freq with boxes fill solid noborder ,\
                  "data/app_P35Pf_err.dat" using (offset($2,2)):(1.0) title "Automatický generátor \\cite{AutoGen}" smooth freq with boxes fill solid noborder ,\
                  "data/app_P35Pf_err.dat" using (offset($3,3)):(1.0) title "Polyopt" smooth freq with boxes fill solid noborder ,\
                  "data/app_P35Pf_err.dat" using (offset($4,4)):(1.0) title "Implementace v MATLABu s nástrojem MOSEK \\cite{mosek}" smooth freq with boxes fill solid noborder ,\
