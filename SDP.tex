...
We will focus in details on this application in \refsec{POP:POP}.
...
\refalg{SDP:scf} is describing the iterative process of solving the optimization problem \refeqb{SDP:scf:minProblem}.
...
The package with implementation of \refalg{SDP:scb:ac} and \refalg{SDP:scb:pf} is named Polyopt, as the semidefinite programming part of this package is only a tool, which is  used for polynomial optimization, which will be described in \refsec{POP:POP}.
