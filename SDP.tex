...
On the other hand, there exist many useful applications of SDP, e.g.\ many problems in combinatorial optimization can be approximated by semidefinite programs as well as many problems arising from automatic control theory.
