...
% --------------------------------------------------------------------------- 
\begin{cmptalkslide}[Lasserrova hierarchie \cite{Lasserre}]
  \setlength{\abovedisplayskip}{0.9em}
  \setlength{\belowdisplayskip}{0.9em}
  \placeat{
    \Put(0,0)[lb]{\footnotesize \cite{Lasserre} J. B. Lasserre. Global optimization with polynomials and the problem of moments.}
  }
  ...
  \begin{itemize}
    ...
    \stepwise{
      \switch{
        \item Semidefinitní problém (nekonečné dimenze)
        \begin{align}
          \arraycolsep=1.4pt
          \begin{array}{rclrcl@{\hskip0.5cm}l}
